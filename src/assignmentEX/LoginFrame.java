		...
		public void actionPerformed(ActionEvent e) {
			...
			/* 로그인 버튼 이벤트 */
				...
				if(uid.equals("") || upass.equals("")) {
					JOptionPane.showMessageDialog(null, "아이디, 패스워드를 정확히 입력해주세요.", "로그인 실패", JOptionPane.ERROR_MESSAGE);
					...
					if(o.db.logincheck(uid, upass)) {	//이 부분이 데이터베이스에 접속해 로그인 정보를 확인하는 부분이다.
						...
						JOptionPane.showMessageDialog(null, uid + "님, 환영합니다.");
						if(uid.equals("admin")) {
							o.af.setVisible(true);
						}
						else {
							o.mf = new MainFrame(o, uid);
